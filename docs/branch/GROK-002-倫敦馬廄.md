...
`1_1` 原型表末尾加 `mews`／`ukMews`（v=0..4 不變，v=5 才是馬廄）。立面：黃庫存磚、左亮右暗、地面拱門、樓上小推拉窗、石板壓頂、戶界煙囪、拱側一盞燈。夜光只畫在已經畫過的窗和燈上。
...
| 項目 | 結果 |
|---|---|
| `ukMewsGROK2` | 13 項綠：左右臉、鄰格內部 0、夜光不浮空、五種舊英式剪影都不同、關閥門回到非馬廄 |
