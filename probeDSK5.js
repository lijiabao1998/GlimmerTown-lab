// probeDSK5.js — DSK-005 皇家音樂廳（k193，2×2）
// 用法：
//   node probeDSK5.js --mode=sprite            精靈放大 3 倍（白天／夜晚／穹頂特寫）——美術迭代用
//   node probeDSK5.js --mode=place             種子城放一座音樂廳，近景（z=2）／遠景（z=0.6）／夜景
//   node probeDSK5.js --mode=ascii             精靈半尺度 ASCII 剪影（白天層，實心像素）
//
...
const OUT = arg('out', 'shotsDSK5');
const KEY = arg('key', '193_1_0');
